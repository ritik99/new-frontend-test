...
export default function LoanNotification() {
    ...
    const [ notificationState, setNotificationState ] = useState(6)
    ...
    const [extensionRequest, setExtensionRequest] = '00'
    const [extensionRequestPercent, setExtensionRequestPercent] = '00'
    const [extensionRequestPercentRequired, setExtensionRequestPercentRequired] = '00'
...
their votes till the end of voting period.
...

            {
                ...
                <div className="loanDetailsRepayAreaDescription">
                   Your requested an extension request on {extensionRequest}
                </div>

                <div className="loanDetailsRepayAreaDescription">
                    {extensionRequestPercent} have voted on favour of extension.
                </div>
                <div className="loanDetailsRepayAreaDescription">
                    {extensionRequestPercentRequired} vote required fpr extension to pass.
                </div>
